...
const PricingCard = (props: IPricingCardProps) => {
  const pricingCardClass = className('p-8', 'border', 'border-gray-200', 'rounded-md', 'bg-white');
  ...
  return (
    <div className={pricingCardClass}>
      ...
      <div className="mt-4 text-gray-700 text-lg font-medium">{props.description}</div>
